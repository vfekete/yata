...
def make_manager(tmp_path):
    ...
    manager._created_log = created
    manager._restored_log = restored
    return manager
...
def test_window_at_finds_the_open_window_containing_the_point(tmp_path):
    ...
    assert manager.windowAt(100, 100) == DEFAULT_WINDOW_ID
    assert manager.windowAt(5000, 5000) == ""
